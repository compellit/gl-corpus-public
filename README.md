...
- Stanza types. The inventory can be seen in the [schema](https://github.com/compellit/corpus-schema/blob/main/compel-schema.odd) and the tool is yet unreleased. 
